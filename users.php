...
<body>
    ...
    $result = mysqli_query($conn, "SELECT * FROM tb_users ORDER BY id_user ASC");
    ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="normal-table-list">
                        <div class="basic-tb-hd">
                            ...
                            <a href="tambahGuru.php"><button class="btn btn-primary btn-icon-notika"><i class="notika-icon notika-plus-symbol" title="tambah"> Tambah Guru</i> </button></a>
                        </div>
                        <div class="bsc-tbl">
                            <table class="table table-sc-ex">
                                ...
                                <tbody>
                                    ...
                                    while($data = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td><a href='editUsers.php?id=$data[id_user]'><button title='edit' class='btn btn-warning btn-sm fa fa-edit'> edit </button>
                                        <button title='hapus' class='btn btn-danger btn-sm fa fa-trash'><a href='deleteUsers.php?id=$data[username]'> hapus </button></td>";
                                        echo"</tr>";
                                    }
                                    ?>
                                </tbody>
