...
include "config.php";
$cariIdSiswa = mysqli_query($conn, "SELECT id_siswa from tb_siswa");
$dataIdSiswa = mysqli_fetch_array($cariIdSiswa);
$data_siswa = mysqli_num_rows($cariIdSiswa);
if ($dataIdSiswa) { 
   $nilaiIdSiswa = substr($data_siswa[0], 1);
   $idSiswa = (int) $nilaiIdSiswa;
   $idSiswa = $data_siswa + 1;
   $otomatisIdSiswa = "".str_pad($idSiswa, STR_PAD_LEFT);
} else {
   $otomatisIdSiswa = "1";
}

$cariNoInduk = mysqli_query($conn, "SELECT no_induk from tb_siswa");
$dataNoInduk = mysqli_fetch_array($cariNoInduk);
$data_nomer = mysqli_num_rows($cariNoInduk);
if ($data_nomer) { 
   $nilaiNoInduk = substr($data_nomer[0], 1);
   $noInduk = (int) $nilaiNoInduk;
   $noInduk = $data_nomer + 1;
   $otomatisNoInduk = "00".str_pad($noInduk, STR_PAD_LEFT);
} else {
   $otomatisNoInduk = "001";
}
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="cmp-tb-hd bcs-hd">
                            ...
                            <p>Form ini akan otomatis menambahkan data siswa ke dalam user sistem. </p>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="id_siswa" value="<?php echo $otomatisIdSiswa ?> ">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="no_induk" value="<?php echo $otomatisNoInduk ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
