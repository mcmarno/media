...
<body>
    ...
    <div class="form-element-area">
        <form action="prosesTambahHasilTugas.php" method="POST" enctype="multipart/form-data">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="cmp-tb-hd bcs-hd">
                            <h2>Upload Tugas</h2>
                            <p>Perhatikan nama tugas dan nama file yang akan diupload</p>
                            <p>File yang diupload harus format pdf</p>
                            <p>File yang diupload tidak dapat diedit kembali, kecuali menghubungi admin sistem</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="no_induk" value="<?php echo $_SESSION['username']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="nama" placeholder="Nama tugas">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div>
                        <button class="btn btn-success notika-btn-success" type="submit" name="submit" title="simpan">Simpan</button>
                        </div>
                    </div>
                </div>
            </div>
