        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div>
                        <?php
                        include "config.php";  //get the goods which will updated
                        $query = "SELECT * FROM tb_materi";  //get the data that will be updated
                    ...
                    <div class="cmp-tb-hd bcs-hd">
                        Youtube : <a href="https://youtu.be/<?php echo $data['youtube'] ?>"><?php echo $data['youtube'] ?></i></a>
                    </div>
                    <div class="cmp-tb-hd bcs-hd">
                        <?php echo $data['isi'] ?>
                    </div>
                    <div>
                        <?php echo "<a href='a.php?id=$data[id_materi]'><button title='unduh' class='btn btn-info btn-sm fa fa-download'> pdf </button>" ?>    
                    </div>
                    <div class="cmp-tb-hd bcs-hd">
                        
                    </div>
                    <div class="videowrapper">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?php echo $data['youtube'] ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
