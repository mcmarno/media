...
<body>
    ...
    $query = "SELECT * FROM tb_users WHERE id_user = '$id'";  //get the data that will be updated
    $hasil = mysqli_query($conn, $query);
  //echo "hasil ==> ".$hasil;
    $data  = mysqli_fetch_array($hasil);
    ?>
    <div class="form-element-area">
        <form action="prosesEditUsers.php" method="POST">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="username" value="<?php echo $data['username'] ?> " readonly="readonly">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
