                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Data Tugas</h2>
                             <a href="tambahHasilTugas.php"><button class="btn btn-primary btn-icon-notika"><i class="notika-icon" title="upload"> Upload tugas</i> </button></a>
                        </div>
                                ...
                                <tbody>
                                   <?php  
                                    while($data = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td><a href='detailTugasSiswa.php?id=$data[id_tugas]'><button title='download' class='btn btn-info btn-sm fa fa-download'> Unduh </button></td>";
                                        echo"</tr>";
                                    }
                                    ?>
                                </tfoot>
